                        ...
                        <div class="col-12 col-sm-5 col-md-12 col-xl-6 mb-4 mb-sm-0 mb-md-4 mb-xl-0">
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="pe-3">Area:</td>
                                        <td id="shipper_area"></td>
                                    </tr>
                                    <tr>
                                        <td class="pe-3">District:</td>
                                        <td id="shipper_district"></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="ubahstatus" aria-labelledby="ubahstatusLabel">
    ...
    <div class="offcanvas-body flex-grow-0 my-auto mx-0">
        ...
        <button type="button" class="btn btn-primary d-grid w-100 mb-2 validasi" onclick="updateStatus();">Continue</button>
    ...
    function reload(params) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var shipper_zipcode = `${obj.data.shipper_zipcode}`;
                var shipper_area = `${obj.bill.shipper_area}`;
                var shipper_district = `${obj.bill.shipper_district}`;
                ...
                var recip_zipcode = `${obj.data.recipient_zip_code}`;
                var recip_area = `${obj.bill.recip_area}`;
                var recip_district = `${obj.bill.recip_district}`;
                ...
                $('#shipper_zipcode').html(shipper_zipcode);
                $('#shipper_area').html(shipper_area);
                $('#shipper_district').html(shipper_district);
                $('#recip_name').html(recip_name);
                $('#recip_phone').html(recip_phone);
                $('#recip_address').html(recip_address);
                $('#recip_zipcode').html(recip_zipcode);
                $('#recip_area').html(recip_area);
                $('#recip_district').html(recip_district);
