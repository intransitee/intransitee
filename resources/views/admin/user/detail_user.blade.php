                        ...
                        <form id="adduser">
                            <form id="updateuserform">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="select2 form-select form-select-lg" id="roles"
                                        onchange="isCustomer(this);" aria-label="Default select example"
                                ...
                                <div class="mb-3" id="field_client" style="display: none">
                                    ...
                                    <small style="color: red">*Silahkan pilih salah satu client yang akan dipegang oleh
                                        customer</small>
                                </div>
                                <button type="button" onclick="updateUser()"
                                    class="btn btn-primary validasi">Simpan</button>
                            </form>
                    </div>
                </div>
            </div>
